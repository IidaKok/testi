...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`bookseries` (`idbookseries`, `bookseries`, `publisher`, `description`, `classification`) VALUES (1, 'Harry Potter', NULL, 'Harry Potter is a series of fantasy novels by J.K. Rowling about a young orphan boy named Harry who learns he is a wizard and attends a school for magic, where he makes friends and fights against the dark wizard Voldemort.', NULL);
INSERT INTO `mydb`.`bookseries` (`idbookseries`, `bookseries`, `publisher`, `description`, `classification`) VALUES (2, 'Lord of the Rings', NULL, 'The Lord of the Rings is a fantasy novel series by J.R.R. Tolkien about a hobbit named Frodo who sets out on a perilous quest to destroy a powerful ring and defeat the dark lord Sauron, with the help of a fellowship of companions.', NULL);
INSERT INTO `mydb`.`bookseries` (`idbookseries`, `bookseries`, `publisher`, `description`, `classification`) VALUES (3, 'Game of Thrones', NULL, 'Game of Thrones is a fantasy novel series by George R.R. Martin about noble families competing for control of the Iron Throne in the fictional world of Westeros, known for its complex characters, intricate plot lines, and gritty realism.', NULL);
INSERT INTO `mydb`.`bookseries` (`idbookseries`, `bookseries`, `publisher`, `description`, `classification`) VALUES (4, 'Hunger Games', NULL, 'The Hunger Games is a dystopian novel series by Suzanne Collins where children from different districts are forced to fight to the death in an annual event, and a young girl named Katniss becomes a symbol of rebellion against the tyrannical Capitol.', NULL);
INSERT INTO `mydb`.`bookseries` (`idbookseries`, `bookseries`, `publisher`, `description`, `classification`) VALUES (5, 'Flintstones', NULL, 'The Flintstones comic books follow the daily lives of the prehistoric Flintstone family and their neighbors in Bedrock, with humor, satire, and nostalgia.', NULL);
